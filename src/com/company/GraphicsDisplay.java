...
// Вывести надпись в точке с вычисленными координатами
        ...
        // Y в точке (0,1)
        GeneralPath Scale = new GeneralPath();
        Point2D.Double center = xyToPoint(0, 1);
        Scale.moveTo(center.x, center.y);
        Scale.lineTo(center.x - 5, center.y);
        Scale.lineTo(center.x + 5, center.y);
        Scale.closePath();
        canvas.draw(Scale);
        //Rectangle2D bounds = axisFont.getStringBounds("1", context);
        canvas.drawString("1", (float)center.x ,(float)center.y);
        //X в точке (1 , 0)
        GeneralPath Scale1 = new GeneralPath();
        Point2D.Double center1 = xyToPoint(1, 0);
        Scale1.moveTo(center1.x, center1.y);
        Scale1.lineTo(center1.x, center1.y-5);
        Scale1.lineTo(center1.x, center1.y+5);
        Scale1.closePath();
        canvas.draw(Scale1);
        canvas.drawString("1", (float)center1.x ,(float)center1.y);
    }
